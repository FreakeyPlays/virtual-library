...
int main() {
	...
	Buch b1("C++: das umfassende Handbuch", "Jürgen Wolf", "Galileo Press", 2014);
	...
	Buch b6("BeagleBone für Einsteiger", "Matt Richardson", "O'Reilly", 2014);
	DVD d1("Die Rächer von C++", "DVD ex", 1984, 666);
	DVD d2("Ganz nah dabei - Raumgestaltung in Kitas / für 0- bis 3-Jährige", "Cornelsen", 2013, 30);
